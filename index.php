...
<head>
    ...
    <link rel="stylesheet" media="screen and (max-width:1480px)" href="css/laptop.css">
        ...
        <div class="container">
          <h1 class="logo" href="#">MOVIE<span class="primary-color">HUB</span></h1>
            ...
            <div class="nav-button-group">
                <button class="btn-login"><i class="fa-solid fa-user">login</i></button>
            </div>
        </div>
    </div>
